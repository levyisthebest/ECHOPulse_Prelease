# ECHOPulse
This repository contains the code for the paper [**ECHOPulse: ECG Controlled Echocardiograms Video Generation**](https://arxiv.org/abs/2401.01827). Aiming to generate the ECHO video based on the ECG signal. Model weights will be released after acceptance.
